...
8G或者以上大小的U盘一个
原版安装镜像一个，是直接AppStore下载的APP文件，注意从网盘下载的DMG文件请挂载后将 【OS X El Capitan 10.11 Developer Beta 1】的文件拷贝到【应用程序】文件夹里。
...
三，开始制作启动盘
请确保【OS X El Capitan 10.11 Developer Beta 1】在【应用程序】文件夹里。
打开【终端】，输入以下命令，

sudo /Applications/Install\ OS\ X\ 10.11\ Developer\ Beta.app/Contents/Resources/createinstallmedia --volume /Volumes/USB01 --applicationpath /Applications/Install\ OS\ X\ 10.11\ Developer\ Beta.app --nointeraction
...
第三步 安装 AICPUPM Patch UEFI ，安装系列驱动
